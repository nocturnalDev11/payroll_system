...
// Define props and assign to a variable
...
<template>
    <button @click="$emit('open')" class="inline-flex items-center gap-2 bg-blue-500 text-white px-3 py-1.5 rounded-md text-sm font-medium 
