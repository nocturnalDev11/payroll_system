    ...
    <div class="min-h-screen bg-gray-50 px-10 py-8">
        <div class="max-w-8xl mx-auto space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <tr v-for="employee in paginatedEmployees" :key="employee.id"
                                ...
                                <td class="px-6 py-4 text-sm text-gray-900 font-medium">{{ employee.empNo }}</td>
                ...
                <!-- Enhanced Pagination -->
                <div v-if="!isLoading" class="px-6 py-4 flex justify-between items-center border-t bg-gray-50">
